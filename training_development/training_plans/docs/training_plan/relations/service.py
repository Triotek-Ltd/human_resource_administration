"""Relation service seed for training_plan."""
...
RELATED_DOCS = [{'doc_id': 'training_session', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'target group from linked employee or team records'}]
