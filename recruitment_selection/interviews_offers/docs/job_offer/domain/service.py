...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'party_reference', 'currency': 'currency_code', 'total_amount': 'total_amount', 'start_date': 'schedule_marker', 'expiry_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'offer_no', 'application', 'offered_role'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'issued', 'accepted', 'declined', 'cancelled', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'issue': 'issued', 'create': None, 'archive': 'archived', 'confirm': None, 'cancel': None}}
