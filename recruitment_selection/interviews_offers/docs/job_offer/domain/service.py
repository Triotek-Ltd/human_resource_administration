...
SIDE_EFFECT_HINTS = {'downstream_effects': ['feeds onboarding and employee master creation'], 'related_docs': ['candidate_application'], 'action_targets': {'create': None, 'issue': 'issued', 'confirm': None, 'cancel': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
