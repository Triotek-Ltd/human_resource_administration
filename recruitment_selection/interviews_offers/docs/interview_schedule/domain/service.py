...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'start_at': 'schedule_marker', 'end_at': 'schedule_marker', 'date_time': 'event_datetime'}, 'search_fields': ['title', 'reference_no', 'description', 'interview_no', 'application', 'date_time'], 'list_columns': ['title', 'start_at', 'end_at', 'workflow_state'], 'initial_state': 'scheduled', 'lifecycle_states': ['scheduled', 'completed', 'cancelled', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'confirm': 'completed', 'create': None, 'archive': 'archived', 'cancel': None}}

WORKFLOW_HINTS = {'business_objective': 'Schedule and track recruitment interviews against candidate applications.', 'actors': ['HR officer', 'hiring manager', 'panel'], 'primary_transitions': ['interview_schedule: scheduled -> completed or cancelled -> archived']}
