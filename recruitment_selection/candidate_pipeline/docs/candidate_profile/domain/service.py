...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state'}, 'search_fields': ['title', 'reference_no', 'description', 'candidate_no', 'name', 'contact_info'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'view': None, 'archive': 'archived', 'update': None}}

WORKFLOW_HINTS = {'business_objective': 'Maintain reusable candidate identity and background data across applications.', 'actors': ['HR officer', 'recruiter'], 'primary_transitions': ['candidate_profile: active -> archived']}
