"""Relation service seed for candidate_application."""
...
RELATED_DOCS = [{'doc_id': 'candidate_profile', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'job_vacancy', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'interview_schedule', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'interview_evaluation', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'job_offer', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'candidate details from candidate_profile'}, {'description': 'vacancy details from job_vacancy'}]
