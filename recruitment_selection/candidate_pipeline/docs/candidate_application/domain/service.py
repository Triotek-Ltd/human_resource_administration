...
ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'under_review', 'shortlisted', 'rejected', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'candidate': 'party_reference', 'application_date': 'schedule_marker', 'screening_status': 'status_flag', 'shortlist_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'application_no', 'candidate', 'vacancy'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'under_review', 'shortlisted', 'rejected', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'review': None, 'progress': None, 'reject': 'rejected', 'close': 'closed', 'archive': 'archived', 'shortlist': 'shortlisted'}}
