...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state'}, 'search_fields': ['title', 'reference_no', 'description', 'description_no', 'role_title', 'duties'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': None, 'archive': 'archived', 'update': None}}

WORKFLOW_HINTS = {'business_objective': 'Maintain reusable role descriptions that feed recruitment and staffing actions.', 'actors': ['HR officer', 'hiring manager'], 'primary_transitions': ['job_description: draft -> active -> archived']}
