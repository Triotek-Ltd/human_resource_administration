...
ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'approved', 'published', 'closed', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'party_reference', 'currency': 'currency_code', 'total_amount': 'total_amount', 'opening_date': 'schedule_marker', 'closing_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'vacancy_no', 'department', 'justification'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'approved', 'published', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'close': 'closed', 'approve': 'approved', 'publish': 'published', 'submit': 'approved', 'archive': 'archived'}}

WORKFLOW_HINTS = {'business_objective': 'Open, approve, publish, and close formal hiring vacancies.', 'actors': ['HR officer', 'hiring manager', 'approver'], 'primary_transitions': ['job_vacancy: draft -> approved -> published -> closed -> archived']}
