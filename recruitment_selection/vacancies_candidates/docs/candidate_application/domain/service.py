"""Business-domain service seed for Candidate Application."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['received', 'screening', 'shortlisted', 'rejected', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'application_date': 'schedule_marker', 'related_candidate_profile': 'relation_collection', 'related_interview_schedule': 'relation_collection', 'related_interview_evaluation': 'relation_collection', 'related_job_offer': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'application_number', 'candidate_name', 'vacancy'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'received', 'lifecycle_states': ['received', 'screening', 'shortlisted', 'rejected', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': None, 'archive': 'archived', 'screen': None, 'shortlist': 'shortlisted', 'reject': 'rejected', 'recommend': None, 'move_to_interview': None}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['feeds onboarding and employee master creation'], 'related_docs': ['candidate_profile', 'job_vacancy', 'interview_schedule', 'interview_evaluation', 'job_offer'], 'action_targets': {'create': None, 'review': None, 'archive': 'archived', 'screen': None, 'shortlist': 'shortlisted', 'reject': 'rejected', 'recommend': None, 'move_to_interview': None}, 'action_side_effects_file': 'side_effects.json'}
