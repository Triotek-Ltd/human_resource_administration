"""Action handler seed for candidate_application:reject."""
...
ACTION_ID = "reject"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['received', 'screening', 'shortlisted', 'rejected'], 'transitions_to': 'rejected'}
