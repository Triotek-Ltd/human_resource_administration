"""Action handler seed for candidate_application:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['received', 'screening', 'shortlisted', 'rejected'], 'transitions_to': 'archived'}
