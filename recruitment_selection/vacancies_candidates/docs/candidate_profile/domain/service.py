"""Business-domain service seed for Candidate Profile."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'related_candidate_application': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'candidate_number', 'name', 'contact_info'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'update': None, 'view': None, 'archive': 'archived'}}

WORKFLOW_HINTS = {'relation_context': {'related_docs': ['candidate_application'], 'borrowed_fields': [], 'inferred_roles': ['hr officer']}, 'actors': ['hr officer'], 'action_actors': {'create': ['hr officer'], 'update': ['hr officer'], 'archive': ['hr officer']}}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['candidate_application'], 'action_targets': {'create': None, 'update': None, 'view': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

class DomainService:
    doc_id = "candidate_profile"
    archetype = "master"
    doc_kind = "master"
