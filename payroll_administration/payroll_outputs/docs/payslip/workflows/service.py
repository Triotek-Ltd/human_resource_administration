...
ACTION_RULES = {'issue': {'allowed_in_states': ['draft', 'issued'], 'transitions_to': 'issued'}, 'create': {'allowed_in_states': ['draft', 'issued'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['draft', 'issued'], 'transitions_to': 'archived'}}
