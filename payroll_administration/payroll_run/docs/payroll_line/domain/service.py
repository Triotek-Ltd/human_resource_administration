"""Business-domain service seed for Payroll Line."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'employee': 'party_reference', 'archive_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'line_number', 'payroll_run', 'employee'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['payroll history becomes available for employee records, finance controls, and reporting outputs'], 'related_docs': ['payroll_run', 'employee_record'], 'action_targets': {'record': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
