"""Relation service seed for payroll_line."""
...
DOC_ID = "payroll_line"
RELATED_DOCS = [{'doc_id': 'payroll_run', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'employee_record', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'employee data from employee_record'}, {'description': 'pay-period context from payroll_run'}]
