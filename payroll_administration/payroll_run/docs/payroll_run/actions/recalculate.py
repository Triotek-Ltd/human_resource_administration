"""Action handler seed for payroll_run:recalculate."""

from __future__ import annotations


DOC_ID = "payroll_run"
ACTION_ID = "recalculate"
ACTION_RULE = {'allowed_in_states': ['draft', 'reviewed', 'approved', 'processed', 'posted'], 'transitions_to': None}
...
def handle_recalculate(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
