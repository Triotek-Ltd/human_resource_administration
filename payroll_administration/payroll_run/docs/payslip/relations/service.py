"""Relation service seed for payslip."""
...
DOC_ID = "payslip"
RELATED_DOCS = [{'doc_id': 'employee_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payroll_run', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'employee identity'}, {'description': 'payroll totals from employee_record'}, {'description': 'payroll_run'}]
