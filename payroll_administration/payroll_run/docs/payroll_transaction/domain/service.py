"""Business-domain service seed for Payroll Transaction."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'posting_flow', 'supports_reconciliation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'posted', 'reconciled', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'reconciliation_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'transaction_number', 'payroll_run', 'posting_date'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'posted', 'reconciled', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'post': None, 'reconcile': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['payroll history becomes available for employee records, finance controls, and reporting outputs'], 'related_docs': ['payroll_run'], 'action_targets': {'record': None, 'post': None, 'reconcile': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
