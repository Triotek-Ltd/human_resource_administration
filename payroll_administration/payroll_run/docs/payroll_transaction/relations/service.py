"""Relation service seed for payroll_transaction."""
...
RELATED_DOCS = [{'doc_id': 'payroll_run', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'period'}, {'description': 'amount context from payroll_run'}]
