...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'employee': 'party_reference', 'taxes': 'tax_breakdown'}, 'search_fields': ['title', 'reference_no', 'description', 'line_no', 'payroll_run', 'employee'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'archive': 'archived', 'review': None}}

WORKFLOW_HINTS = {'business_objective': 'Store per-employee payroll calculations for each payroll run.', 'actors': ['payroll officer'], 'primary_transitions': ['payroll_line: active -> archived']}
