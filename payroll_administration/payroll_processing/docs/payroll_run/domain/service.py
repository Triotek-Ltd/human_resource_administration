...
ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'approved', 'processed', 'closed', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'party_reference', 'currency': 'currency_code', 'total_amount': 'total_amount', 'run_date': 'schedule_marker', 'gross_total': 'monetary_value', 'net_total': 'monetary_value'}, 'search_fields': ['title', 'reference_no', 'description', 'run_no', 'pay_period', 'run_date'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'approved', 'processed', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'issue': None, 'review': None, 'close': 'closed', 'approve': 'approved', 'archive': 'archived'}}

WORKFLOW_HINTS = {'business_objective': 'Anchor each payroll cycle and drive lines, payslips, and finance postings.', 'actors': ['payroll officer', 'approver'], 'primary_transitions': ['payroll_run: draft -> approved -> processed -> closed -> archived']}
