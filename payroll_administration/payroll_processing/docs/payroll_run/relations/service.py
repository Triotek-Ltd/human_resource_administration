...
DOC_ID = "payroll_run"
RELATED_DOCS = [{'doc_id': 'attendance_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payroll_line', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payslip', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'payroll_transaction', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
