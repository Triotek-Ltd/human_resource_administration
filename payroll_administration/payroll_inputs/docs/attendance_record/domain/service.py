...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'party_reference', 'currency': 'currency_code', 'total_amount': 'total_amount', 'employee': 'party_reference', 'approval_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'attendance_no', 'employee', 'period'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'approved', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'archive': 'archived', 'create': None, 'approve': 'approved', 'review': None}}

WORKFLOW_HINTS = {'business_objective': 'Capture approved attendance and leave inputs used for payroll processing.', 'actors': ['employee', 'manager', 'payroll officer'], 'primary_transitions': ['attendance_record: draft -> approved -> archived']}
