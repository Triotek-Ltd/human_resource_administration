...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'start_date': 'schedule_marker', 'end_date': 'schedule_marker', 'publication_date': 'schedule_marker', 'close_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'cycle_no', 'start_date', 'end_date'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'published', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'archive': 'archived', 'publish': 'published', 'update': None}}
