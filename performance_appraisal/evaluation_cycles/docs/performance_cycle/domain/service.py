"""Business-domain service seed for Performance Cycle."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'configuration_control', 'case_management': False}, 'reporting_profile': {'supports_snapshots': False, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': True}, 'lifecycle_states': ['draft', 'published', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'publication_date': 'schedule_marker', 'close_date': 'schedule_marker', 'related_performance_appraisal': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'cycle_number', 'start', 'end_dates'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'published', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'update': None, 'publish': 'published', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['supports employee growth and performance management'], 'related_docs': ['performance_appraisal'], 'action_targets': {'create': None, 'update': None, 'publish': 'published', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
