"""Business-domain service seed for Performance Appraisal."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'employee': 'party_reference', 'review_date': 'schedule_marker', 'related_performance_cycle': 'relation_collection', 'related_performance_rating': 'relation_collection', 'related_improvement_plan': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'appraisal_number', 'employee', 'review_period_start'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'in_review', 'approved', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'submit': 'in_review', 'review': 'in_review', 'approve': 'approved', 'close': 'closed', 'check_in': None, 'acknowledge': None, 'reopen': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['supports employee growth and performance management'], 'related_docs': ['employee_record', 'performance_cycle', 'performance_rating', 'improvement_plan'], 'action_targets': {'create': None, 'submit': 'in_review', 'review': 'in_review', 'approve': 'approved', 'close': 'closed', 'check_in': None, 'acknowledge': None, 'reopen': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
