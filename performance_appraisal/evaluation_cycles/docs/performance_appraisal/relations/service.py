"""Relation service seed for performance_appraisal."""
...
RELATED_DOCS = [{'doc_id': 'employee_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'performance_cycle', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'performance_rating', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'improvement_plan', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'field_id': 'employee', 'source_doc_id': 'employee_record', 'fetch_profile': 'employee_profile', 'fetch_fields': ['title', 'reference_no', 'employee_id', 'legal_name', 'preferred_name', 'work_email', 'work_phone'], 'purpose': 'party_reference'}]

BORROWED_FIELDS = [{'description': 'employee'}, {'description': 'department details from employee_record'}, {'description': 'cycle dates from performance_cycle'}]
