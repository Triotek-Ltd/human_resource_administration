"""Relation service seed for performance_rating."""
...
RELATED_DOCS = [{'doc_id': 'performance_appraisal', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'appraisal context from performance_appraisal'}]
