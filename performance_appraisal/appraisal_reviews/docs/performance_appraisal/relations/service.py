...
RELATED_DOCS = [{'doc_id': 'performance_cycle', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'performance_rating', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'improvement_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'employee_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'fetch_profile': 'employee_profile', 'field_id': 'employee', 'purpose': 'party_reference', 'source_doc_id': 'employee_record', 'fetch_fields': ['title', 'reference_no', 'employee_id', 'legal_name', 'preferred_name', 'work_email', 'work_phone']}]

BORROWED_FIELDS = [{'description': 'employee details from employee_record'}, {'description': 'cycle details from performance_cycle'}]
