"""Workflow service seed for employment_contract."""
...
ACTION_RULES = {'issue': {'allowed_in_states': ['draft', 'approved', 'signed'], 'transitions_to': None}, 'submit': {'allowed_in_states': ['draft', 'approved', 'signed'], 'transitions_to': 'approved'}, 'create': {'allowed_in_states': ['draft', 'approved', 'signed'], 'transitions_to': None}, 'approve': {'allowed_in_states': ['draft', 'approved', 'signed'], 'transitions_to': 'approved'}, 'archive': {'allowed_in_states': ['draft', 'approved', 'signed'], 'transitions_to': 'archived'}}
