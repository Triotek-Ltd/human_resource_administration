...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'employee': 'party_reference', 'start_date': 'schedule_marker', 'owner': 'actor_reference'}, 'search_fields': ['title', 'reference_no', 'description', 'case_no', 'employee', 'start_date'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_progress', 'completed', 'closed'], 'terminal_states': ['closed'], 'action_targets': {'confirm': 'completed', 'create': None, 'assign': 'in_progress', 'close': 'closed', 'track': None}}
