"""Relation service seed for onboarding_case."""
...
BORROWED_FIELDS = [{'description': 'role'}, {'description': 'department'}, {'description': 'supervisor'}, {'description': 'start date from employee_record'}]
