"""Business-domain service seed for Onboarding Case."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'in_progress', 'completed', 'closed'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'employee': 'party_reference', 'start_date': 'schedule_marker', 'checklist_summary': 'structured_payload', 'owner': 'actor_reference'}, 'search_fields': ['title', 'reference_no', 'description', 'case_number', 'employee', 'start_date'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_progress', 'completed', 'closed'], 'terminal_states': ['closed'], 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'confirm': 'completed', 'close': 'closed'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['employee_record'], 'action_targets': {'create': None, 'assign': 'in_progress', 'track': None, 'confirm': 'completed', 'close': 'closed'}, 'action_side_effects_file': 'side_effects.json'}
