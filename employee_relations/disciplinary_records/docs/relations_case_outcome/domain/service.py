"""Business-domain service seed for Relations Case Outcome."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'closure_date': 'schedule_marker', 'archive_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'outcome_number', 'grievance', 'decision_summary'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'confirmed', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'confirm': 'confirmed', 'archive': 'archived'}}

WORKFLOW_HINTS = {'relation_context': {'related_docs': ['employee_grievance'], 'borrowed_fields': ['issue summary', 'parties from employee_grievance'], 'inferred_roles': ['hr officer', 'case owner']}, 'actors': ['hr officer', 'case owner'], 'action_actors': {'create': ['hr officer'], 'confirm': ['case owner'], 'archive': ['case owner']}}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['employee_grievance'], 'action_targets': {'create': None, 'confirm': 'confirmed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
