...
ACTION_RULES = {'create': {'allowed_in_states': ['open', 'in_review', 'resolved'], 'transitions_to': None}, 'escalate': {'allowed_in_states': ['open', 'in_review', 'resolved'], 'transitions_to': None}, 'review': {'allowed_in_states': ['open', 'in_review', 'resolved'], 'transitions_to': 'in_review'}, 'close': {'allowed_in_states': ['open', 'in_review', 'resolved'], 'transitions_to': 'closed'}, 'assign': {'allowed_in_states': ['open', 'in_review', 'resolved'], 'transitions_to': 'in_review'}, 'archive': {'allowed_in_states': ['open', 'in_review', 'resolved'], 'transitions_to': 'archived'}}
