"""Relation service seed for employee_grievance."""
...
RELATED_DOCS = [{'doc_id': 'employee_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'relations_case_note', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'disciplinary_action', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'relations_case_outcome', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'employee details from employee_record'}]
