...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'employee': 'party_reference', 'issue_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'grievance_no', 'employee', 'issue_date'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_review', 'resolved', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'escalate': None, 'review': 'in_review', 'close': 'closed', 'assign': 'in_review', 'archive': 'archived'}}
