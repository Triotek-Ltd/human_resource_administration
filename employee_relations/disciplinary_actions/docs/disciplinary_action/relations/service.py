"""Relation service seed for disciplinary_action."""
...
RELATED_DOCS = [{'doc_id': 'employee_grievance', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'employee_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'fetch_profile': 'case_context', 'field_id': 'party', 'purpose': 'party_reference', 'source_doc_id': 'employee_grievance', 'fetch_fields': ['title', 'reference_no', 'workflow_state', 'transaction_date', 'status']}, {'fetch_profile': 'employee_profile', 'field_id': 'employee', 'purpose': 'party_reference', 'source_doc_id': 'employee_record', 'fetch_fields': ['title', 'reference_no', 'employee_id', 'legal_name', 'preferred_name', 'work_email', 'work_phone']}]

BORROWED_FIELDS = [{'description': 'employee details from employee_record'}, {'description': 'case context from employee_grievance'}]
