...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'party_reference', 'currency': 'currency_code', 'total_amount': 'total_amount', 'employee': 'party_reference', 'issue_date': 'schedule_marker', 'effective_date': 'schedule_marker'}, 'search_fields': ['title', 'reference_no', 'description', 'action_no', 'employee', 'grievance_or_incident'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'approved', 'issued', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'issue': 'issued', 'submit': 'approved', 'create': None, 'approve': 'approved', 'archive': 'archived'}}
