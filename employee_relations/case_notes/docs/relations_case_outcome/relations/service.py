"""Relation service seed for relations_case_outcome."""
...
RELATED_DOCS = [{'doc_id': 'employee_grievance', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'fetch_profile': 'case_context', 'field_id': 'party', 'purpose': 'party_reference', 'source_doc_id': 'employee_grievance', 'fetch_fields': ['title', 'reference_no', 'workflow_state', 'transaction_date', 'status']}]

BORROWED_FIELDS = [{'description': 'grievance context from employee_grievance'}]
