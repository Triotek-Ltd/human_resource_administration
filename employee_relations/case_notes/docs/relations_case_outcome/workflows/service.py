...
ACTION_RULES = {'confirm': {'allowed_in_states': ['draft', 'confirmed'], 'transitions_to': 'confirmed'}, 'create': {'allowed_in_states': ['draft', 'confirmed'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['draft', 'confirmed'], 'transitions_to': 'archived'}}
