"""Business-domain service seed for Employee Grievance."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['open', 'in_review', 'resolved', 'closed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'employee': 'party_reference', 'issue_date': 'schedule_marker', 'owner': 'actor_reference', 'related_relations_case_note': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'grievance_number', 'employee', 'issue_date'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'open', 'lifecycle_states': ['open', 'in_review', 'resolved', 'closed', 'archived'], 'terminal_states': ['closed', 'archived'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'escalate': None, 'close': 'closed', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['supports HR compliance and risk management'], 'related_docs': ['employee_record', 'relations_case_note'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'escalate': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
