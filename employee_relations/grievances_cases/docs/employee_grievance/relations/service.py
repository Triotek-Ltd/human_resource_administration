...
RELATED_DOCS = [{'doc_id': 'employee_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'relations_case_note', 'relation_type': 'related', 'show_in_related_panel': True}]
...
BORROWED_FIELDS = [{'description': 'employee'}, {'description': 'department context from employee_record'}]
