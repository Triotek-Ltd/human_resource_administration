"""Business-domain service seed for Relations Case Note."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'note_date': 'schedule_marker', 'author': 'actor_reference'}, 'search_fields': ['title', 'reference_no', 'description', 'note_number', 'grievance', 'note_date'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'view': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['employee_grievance'], 'action_targets': {'record': None, 'view': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
